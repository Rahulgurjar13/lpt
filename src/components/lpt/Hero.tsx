import { ArrowRight, Star, Users, Trophy, Home, CheckCircle2, Award, FileText, MonitorPlay, PlayCircle, Library, LineChart } from "lucide-react";
  ...
  return (
    <section className="relative overflow-hidden pt-[120px] pb-10 lg:pt-[150px] lg:pb-16">
      ...
      <div
        ...
        style={{
          background: "radial-gradient(50% 50% at 50% 0%, #FFF9F2 0%, #FFFFFF 100%)",
        }}
      />
      ...
      <div className="container-lpt grid items-center gap-12 lg:grid-cols-[1.1fr_1fr] lg:gap-16">
        ...
        <Reveal>
          ...
          <div className="mb-8 inline-flex items-center rounded-full border border-ink/5 bg-[#0F1015] py-1.5 pl-1.5 pr-5 text-[13px] font-semibold text-white shadow-xl shadow-brand/5 transition-transform hover:-translate-y-0.5">
            ...
            India's Top MBA & IPMAT Coaching
          </div>
          ...
          <p className="mt-8 max-w-lg text-body text-lg leading-relaxed text-gray-600">
            Trusted by 1,50,000+ students. Proven results for CAT,
            IPMAT, and CUET with expert mentors and structured
            preparation.
          </p>
          ...
          <div className="mt-8 flex flex-wrap items-center gap-4">
            <button onClick={onBook} className="btn-primary px-8 py-3.5 text-base shadow-lg shadow-brand/20">
              Book Free Counselling <ArrowRight className="h-4 w-4" strokeWidth={2.2} />
            </button>
            <button className="flex items-center justify-center gap-2 rounded-full border border-gray-300 bg-white px-8 py-3.5 text-base font-semibold text-ink transition-all hover:bg-gray-50 hover:border-gray-400">
              Explore Courses
            </button>
          </div>

          {/* Professional Typography-Driven Stats */}
          <div className="mt-14 flex flex-wrap items-center gap-8 md:gap-12">
            <div className="flex flex-col">
              <span className="font-display text-3xl font-bold tracking-tight text-ink">150K+</span>
            ...
            <div className="flex flex-col">
              <span className="font-display text-3xl font-bold tracking-tight text-ink">100+</span>
              <span className="mt-1 text-sm font-medium text-body/80">IIM Calls in '25</span>
            </div>

            <div className="hidden h-10 w-px bg-black/[0.06] md:block" />

            <div className="flex flex-col">
              <span className="font-display text-3xl font-bold tracking-tight text-ink">30+</span>
              <span className="mt-1 text-sm font-medium text-body/80">Offline Centers</span>
            </div>
          </div>
        </Reveal>
        ...
        <Reveal delay={120}>
          <div className="relative mx-auto mt-12 w-full max-w-[500px] lg:mt-0 lg:max-w-none">
            {/* Main Image with rounded top-left corner */}
      ...
      {/* BOTTOM DARK BAR (Essential Resources) */}
        ...
        <div className="flex flex-wrap items-center justify-between gap-6 rounded-2xl bg-[#0F1015] px-8 py-6 text-white shadow-2xl">
          {[
            ...
            <div key={i} className="flex items-center gap-6">
              <a href="#" className="flex items-center gap-3 text-sm font-medium transition-colors hover:text-brand-wash">
